...
class Ssh:
    ...
    def container(self) -> Container:
        ...
        self.container_ = (
            ...
            .with_exec(["adduser", "-D", "-u", self.user_id, "-h", f"/home/{self.user_id}", self.user_id])
    ...
    @function
    async def with_private_key(self, source: Annotated[dagger.File, Doc("Private key file")]) -> str:
